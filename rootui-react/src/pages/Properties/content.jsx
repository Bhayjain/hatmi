                                    ...
                                    <div className="row">
                                       ...
                                       this.state.property_imgaes_array.map((value,index)=>{
                                        ...
                                        <div className="col-lg-3 col-md-3 mt-20">
                                                <div>
                                                    <input id="inputGroupFileProperty" type="file" accept="image/png, image/gif, image/jpeg, image/jpg, image/svg+xml,image/svg" className="no_input_file" multiple onChange={this.handlePropertyImagess} style={{display:"none"}} />
