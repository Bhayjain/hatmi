      ...
      if(this.state.button == "Save"){
       ...
       add_employee=()=>{
         ...
         for (var i = 0; i < property_array.length; i++) {
           if(property_array[i].checked == true){
            property_id.push(property_array[i]._id)
           }
         }
       ...
       edit_employee=()=>{
        ...
        // console.log("loginCookies",loginCookies);
         ...
         if (this.state.property_change != "change") {
                ...
                select_all_property=(checked)=>{
                    ...
                    for (var i = 0; i < property_array.length; i++) {
                      ...
                      if (checked == true) {
                          ...
                          var indor_dat ={property_name :property_array[i].property_name,property_id :property_array[i]._id, checked:checked}
                          property_select.push(indor_dat)
                  ...
                  toggleCheckboxProperty=(e,value,index)=>{
                      ...
                      if (e.target.checked==true) {
                          var indor_dat ={property_name :value.property_name,property_id :value._id, checked:true}
                          ...
                          var indor_dat ={property_name :value.property_name,property_id :value._id, checked:false}
                                             ...
                                             <div className="box_data_employee">
                                                 ...
                                                 <div className="row test_collapse">
                                                        <div className="col-lg-8 col-md-8 col-sm-12">
                                                            ...
                                                            <div className="col-lg-6 col-md-6 col-sm-12 mt-20" style={{display: value.total_paid_leave == "" || value.total_paid_leave == undefined ? "none" : "block"}}>
                                                    ...
                                                    <div className="col-lg-4 col-md-4 col-sm-12 mt-10" >
                                                        ...
                                                        <div className="bottom_value">{value.property_obj ? value.property_obj.map((val,ind)=>{
                                                            return(
                                                                <div key={ind} className="BulletData">{val.label}</div>
                                                            )
                                                        }) : ""}</div>
                                                    </div>
                         ...
                         <div className="form rui-sign-form rui-sign-form-cloud">
                             ...
                             <div className="col-lg-12 col-md-12 col-xs-12 inputHeight">
                                     ...
                                     <div className="col-lg-4 col-md-4 col-xs-12 mt-15">
                                        ...
                                        <div className="col-lg-12 col-md-12 mt-10 mt-15">
                                            ...
                                            {this.state.property_array.map((value,index)=>{
                                                return(
                                                    <div className="col-lg-4 col-md-4 mb-10" key={index}>
                                                        <div className="newinlinenew">
                                                            <CustomInput type="checkbox" invalid={this.state.borderNew && this.state.property_select == ""  ? true : false} label={value.property_name + ", " +value.property_city }  checked ={value.checked == true ? true :false}  id={"formCheckbox1" + index}
