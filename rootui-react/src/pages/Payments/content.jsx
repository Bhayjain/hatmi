                                            ...
                                            <Table>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" className="borderTopNone">Check in - out</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>{value.check_in_out}</td>
                                                        <td  style={{textAlign:"end"}}>&#x20b9;{value.amount}</td>
                                                        <td  style={{textAlign:"end"}}>&#x20b9;{value.due}</td>
                                                        <td aria-hidden="true" onClick={()=>{this.redirect_to_booking(value)}}><div className={value.status == "Paid" ? "paid_data" :"pending_data"}>{value.status}</div></td>
                                                    </tr>
                                                        )
                                                    })}
