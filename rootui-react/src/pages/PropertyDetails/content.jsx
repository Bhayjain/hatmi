...
var is_admin_view = Cookies.get("is_admin_view")
    ...
    checkNumber() {
        ...
        const isValid = phone_number && isValidmobile_number(phone_number);
 ...
 edit_property_for_images=()=>{
  ...
  edit_property = () => {
    ...
    //  console.log("this.state.property_name",this.state.property_name);
    //  console.log("this.state.description",this.state.description);
    //  console.log("this.state.property_type",this.state.property_type);
    ...
    //  console.log("this.state.max_guest_data",this.state.max_guest_data);
    //  console.log("this.state.add_area_details",this.state.add_area_details);
...
handlePropertyImagess = async (event) => {
  ...
  remove_propert_imges(t) {
    ...
    componentDidMount(){
       ...
       if (is_admin_view == "true") {
           
           var property_uid_cook = Cookies.get('property_uid');
       }else{
        var property_uid_cook = hatimi_login_data.property_obj[0].property_uid
       }
       ...
       socket.on('update_property_emp_response', (data) => {
        ...
        this.get_single_property(data.data.property_uid)
        ...
        this.setState({
         ...
         console.log("gst",this.state.gst);
           ...
           if (this.state.room_name == "" || this.state.room_name == undefined || this.state.room_type == "" || this.state.room_type == undefined ||  this.state.room_charges == "" || this.state.room_charges == undefined ||  this.state.max_guest_in_room == "" || this.state.max_guest_in_room == undefined ||  this.state.room_size == "" || this.state.room_size == undefined ||  this.state.room_bed_size == "" || this.state.room_bed_size == undefined || this.state.room_disceription =="" || this.state.room_disceription == undefined
                ...
                console.log("max_guest_in_room",this.state.max_guest_in_room);
               this.setState({
                ...
                <PageTitle className="PageTitle">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 textAlignEnd">
                            <Button disabled={this.state.properties_dock_control == "false" ? true : false} color="primary" onClick={this.toggle}>Edit Property</Button>
                        </div>
                    </div>
                </PageTitle>
                         ...
                         {this.state.property_array.map((value,index)=>{
                                    ...
                                    <div className="row">
                                        <div className="col-lg-5 col-md-4 resortImgForAllDetailsNew">
                                            ...
                                            <div className="uploadPropertImage">
                                               <input id="inputGroupFileProperty" type="file" accept="image/png, image/jpeg, image/jpg, image/svg+xml,image/svg" className="no_input_file" multiple onChange={this.uploadPropertyImagess} style={{display:"none"}} />
                             ...
                             <div className="roomDataStart mt-30">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-6 textAlignEnd">
                                        <Button disabled={this.state.properties_dock_control == "false" ? true : false} color="primary" onClick={this.openNavExcel}>Add Room</Button>
                                    </div>
                                </div>
                ...
                <div className="please" style={{ padding: "6px 14px" }}>
                 ...
                 <div className="show_dataNew mycalendar mt-20" style={{ height: my_height -131 }}>
                    ...
                    <div className="col-lg-3 col-md-3 mt-20">
                            <div>
                                <input id="inputGroupFileRoom" type="file" accept="image/png, image/jpeg, image/jpg, image/svg+xml,image/svg"  className="no_input_file" multiple onChange={this.handleChangeFile_Quotationn} style={{display:"none"}} />
                          ...
                          <div className="row">
                              ...
                              <div className="col-lg-6 col-md-6 mb-15">
                                   <Label className="labelforall">Phone Number<span className="start_mark_new">*</span></Label>
                                    ...
                                    value={phone_number ? phone_number.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1') : ""}
                                    invalid={this.state.borderRed && phone_number == "" ? true : false}
                  ...
                  <h3 className="headingNew">Profile Information</h3>
                      <div className="row">
                         ...
                         this.state.property_imgaes_array.map((value,index)=>{
                          ...
                          <div className="col-lg-3 col-md-3 mt-20">
                                  <div>
                                      <input id="inputGroupFileProperty" type="file" accept="image/png, image/jpeg, image/jpg, image/svg+xml,image/svg" className="no_input_file" multiple onChange={this.handlePropertyImagess} style={{display:"none"}} />
