...
//console.log("is_admin_view@@@@@@@@@@@@@@@@@@@@@@@",is_admin_view);
...
if (is_admin_view == "true" ) {
    ...
    if (properties_dock_view == "true") {
        nevigation_sidebar['/peoperty-details'] = {
            name: 'Properties',
            icon: 'properties',
            iconInActive: require( '../../common-assets/images/icons/properties.svg' ),
            iconActive: require( '../../common-assets/images/icons white/properties.svg' ),
...
const settings = {
    // api_url : "http://dev-server.bovo.world:3000/", //Demo Link Slot
    api_url : "http://192.168.29.184:3000/", //Demo Link Slot
    // api_url : "http://54.92.222.79:3000/", //Demo Link Slot
    // api_url_phase_2 : "http://dev-server.bovo.world:3000/", //Demo Link Slot
