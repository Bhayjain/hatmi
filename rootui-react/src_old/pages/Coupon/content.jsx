...
class Content extends Component {
    ...
    add_coupon() {
      ...
      if (params.name == "" || params.name == undefined || params.expiry == "" || params.expiry == undefined || this.state.discount_type == "" || this.state.discount_type == undefined || params.property_uids == "" || params.property_uids == undefined || params.property_uids.length == 0) {
          this.setState({
 ...
 for_edit(x){
   ...
   console.log("x.expiry",new Date(x.expiry));
   var date = (x.expiry).split('-')
   var new_date = date[2]+'-'+date[1]+'-'+date[0]
   console.log("new_date",new_date);
   console.log("new_date",new Date(new_date));
                             ...
                             this.state.coupon_array.map((value, index) => {
                                 ...
                                 return (
                                   <tr  key={index}>
                                       ...
                                       <td  style={{verticalAlign:"middle",padding:"5px 25px"}}>{value.discount_percent==null ?  (<div>{"Rs "+value.discount_flat}</div>) : (<div>{value.discount_percent+"%"}</div>)}</td>
               ...
               >
                   ...
                   <ModalBody>
                     <div className="row">
                       ...
                       <Label className="ballllllll" for="pcvCap">Coupon Name</Label>
                      ...
                      <div className="col-lg-6 col-md-6 col-xs-12">
                       ...
                       <div style={{display:"inline-flex",width:"100%"}}>
                           <CustomInput checked={this.state.discount_type == "percentage" ? true :false} type="radio" invalid={this.state.borderNew && this.state.discount_type == "" ? true :false} id="formRadio1" name="formRadio" label="Discount Percentage" onClick={()=>{this.setState({discount_type:"percentage", discount_amount:''})}} />
                      ...
                      <div style={{display:"inline-flex",width:"100%"}}>
                          <div >
                          <CustomInput checked={this.state.discount_type == "amount" ? true :false} type="radio" invalid={this.state.borderNew && this.state.discount_type == "" ? true :false} id="formRadio2" name="formRadio" label="Discount Amount" onClick={()=>{this.setState({discount_type:"amount", discount_percentage:''})}}/>
                          </div>
                      </div>
                      <div className="">
                               ...
                               return(
                                  <div className="col-lg-6 col-md-6 mb-10" key={index}>
                                      <div className="newinlinenew">
                                          <CustomInput type="checkbox" label={value.property_name + "," +value.property_city }  checked ={value.checked == true ? true :false}  id={"formCheckbox1" + index}
                   ...
                   <p style={{color:"red",marginBottom:"0px"}}>{this.state.error_message}</p>
                       ...
                       { ' ' }
                       <Button style={{color:"#fff"}} color="primary" onClick={()=> this.switch_function() }>{this.state.button}</Button>
                   </ModalFooter>
               </Modal>
