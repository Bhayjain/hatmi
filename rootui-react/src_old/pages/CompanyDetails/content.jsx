                                            ...
                                            <div className="row">
                                                ...
                                                {/* <div className="col-lg-12 col-md-12 mt-15">
                                                      ...
                                                      <div className="col-lg-12 col-md-12 col-sm-12 mt-15">
                                                        ...
                                                        <input id="inputGroupFile01" type="file" placeholder="Choose Logo" accept="image/png, image/jpeg, image/jpg" className="no_input_file" disabled={this.state.master_control == "false" ? 'disabled' : ''} multiple onChange={this.handleChangeFile_Quotationn} style={{display:"none"}} />
