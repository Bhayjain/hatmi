            ...
            >
                ...
                <ModalBody>
                  ...
                  <div className='display_inline'>
                      ...
                      onChange={(e) => { this.setState({ sgst: e.target.value }) }} /><span className='percent'>%</span></div>
                  </div>
                  <div className="col-lg-4 col-md-12">
                  ...
                  <div className='display_inline'>
                      ...
                      onChange={(e) => { this.setState({ cgst: e.target.value }) }} /><span className='percent'>%</span></div>
                  </div>
                  <div className="col-lg-4 col-md-12">
