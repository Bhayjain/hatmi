      ...
      <Fragment>
        <PageTitle className="admin_title border_title">
          <div style={{ width: "100%", display: "inline-flex" }}>
            <h1 className="toppp_neeee" style={{ marginTop: "0px" }}>Designation</h1>
            <Button id="add_role" className="toppp_neeee" color="primary"  style={{ backgroundColor: "rgb(0,123,255)", borderColor: "rgb(0,123,255)", color: "#fff", textTransform: "capitalize", marginLeft: "auto" }} onClick={this.toggle}>Add Designation</Button>
          </div>
        </PageTitle>
                    ...
                    <div className="row" style={{ marginBottom: "15px" }}>
                      ...
                      <div className="col-lg-6 col-md-12 col-sm-12">
                        <div className="row">
                          ...
                          <div className="col-lg-12 col-md-12 col-sm-12 mb-10" style={{ display: "inline-flex" }}>
                            <div className="mobile desi" style={{ width: "160px", whiteSpace: "nowrap" }}>Swap</div>:
                            <span style={{ marginLeft: "23px" }} className="displayIconInline">
                              <div className="forSmallDevices2"><div style={{ marginRight: '0px' }}>
                                <CustomInput
