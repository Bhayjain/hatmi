...
class Content extends Component {
    ...
    get_all_property_room = () => {
        var property_uid = Cookies.get("property_uid")
        const { settings } = this.props;
        console.log("this.state.property_uid_cook", property_uid);
    ...
    fetch_notification_count() {
        ...
        socket.on('fetch_task_badge_response', (data) => {
            console.log('inside fetch_task_badge_response Task Page =============', data);
        ...
        const res = fetch(settings.api_url_phase_2 + "v1/task/get-single-task", {
            ...
            .then(json => {
                ...
                if (data.status == true) {
                    ...
                    var img = []
                    var img_new = data.data.task_image
    ...
    add_task = () => {
        ...
        if (this.state.add_task_time == "" || this.state.add_task_time == undefined || this.state.assign_employee == "" || this.state.assign_employee == undefined || this.state.task_date == "" || this.state.task_date == undefined || this.state.task_type == "" || this.state.task_type == undefined) {
            ...
            var params = {
                property_id: property_id_cookies,
            ...
            <Fragment>
                ...
                <div className="row marrginnn_new" style={{ display: this.state.isLoading == "none" ? "flex" : "none" }}>
                    <div className="col-lg-4 col-md-12 col-sm-12 heading_opeartion height_sales" style={{ paddingRight: "0px", display: this.state.ipad_emp_list }}>
                        ...
                        <div className="heading_opeartion mycalendar" style={{ height: my_height }}>
                                        ...
                                        {this.state.single_task_array.map((value, index) => {
                                            ...
                                            return (
                                                <div className="show_deatilsss" key={index}>
                                                    <div className="task_data_show test_collapse mycalendar" style={{height: my_height-76}}>
                                                        ...
                                                        {value.task_image.length > 0 ?
                                                            <div style={{marginTop:"10px"}} className="task_detais_sec test_collapse">
                                                                <div className="row">
                                                                    <div className="col-lg-6 col-md-6">
                                                                        {/* <h3 className='taskDetailsHeading'>Images For Task Approval</h3> */}
                                                                    </div>
                                                                    {value.task_status == "approved" ? "" :
                                                                        <div className="col-lg-6 col-md-6 task_btn">
                                                                            <Button style={{ color: "#fff" }} color="warning" onClick={() => {
                                                                                this.setState({
                                                                                    AlertDeleteSingle: true,
                                                                                    task_id: value._id,
                                                                                    loading: false,
                                                ...
                                                {/* <h3 className='taskDetailsHeading'>Chat With Employee</h3> */}
                                                            <div>
                                                                <div className="meesage_div_new " style={{ height: value.conversation_array.length == 0 ? my_height - 486 : "", marginTop: "10px" }}>
                ...
                >
                    <ModalBody>
                        ...
                        <div style={{ height: '50px', width: '100%' }}>
                            ...
                            <Button color="primary" disabled={this.state.policy_dock_control == "false" ? 'disabled' : ''}
                                style={{ color: "#fff" }}
                                onClick={() => {
                ...
                >
                    <div className="modal-header">
                        {/* <h5 className="modal-title h2">Images For Task Approval</h5> */}
