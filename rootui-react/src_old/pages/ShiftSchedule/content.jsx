            ...
            <Fragment>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-7 foms_date">
                            <div style={{ display: this.state.activeTab2 === 'profile' ? "block" : "none" }}>
                                <Button color="primary" onClick={() => { this.toggle() }} >Add Shift Model</Button>
                            </div>
                ...
                >
                    ...
                    <ModalFooter>
                        ...
                        {' '}
                        <Button color="primary" style={{ color: "#fff" }} onClick={this.switch_attendance}>{this.state.shift_button}{this.state.loading ? (
                            <Spinner />
                        ) : ''}</Button>
                    </ModalFooter>
                </Modal>
