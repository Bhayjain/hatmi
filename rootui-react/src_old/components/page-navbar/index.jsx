...
class PageNavbar extends Component {
    ...
    componentDidMount() {
        ...
        var HatimiProject = Cookies.get("property_name")
        console.log("HatimiProject@@@@@@@@@@@@@@@@",HatimiProject);

        this.setState({
            property_name : HatimiProject
        })
        ...
        return (
            <>
                ...
                {/* <Dropdown tag="li" direction="up" openOnHover={ ! isMobile } showTriangle>
                 ...
                 { ! isMobile ? (
                    <h2 className="propertyNameData">{this.state.property_name}</h2>
                    // <Dropdown tag="li" direction="up" openOnHover showTriangle>
                    //     <Dropdown.Toggle tag="a" href="#" className="dropdown-item rui-navbar-avatar mnr-6  newAvtar">
                    //         <img src={ settings.users[ 0 ].img } alt="img" />
                    //     </Dropdown.Toggle>
                    //     <Dropdown.Menu tag="ul" className="nav dropdown-menu ">
                    //         <li>
                  ...
                  <Dropdown.Toggle
                    ...
                    >
                        { isMobile ? (
                            ...
                            <span className="btn btn-custom-round">
                                <Icon name="bell" className="mr-0 belllNew" />
                                <span className="badge badge-circle badge-brand">3</span>
                            </span>
                        ) }
                    </Dropdown.Toggle>
                    <Dropdown.Menu tag="ul" className="nav dropdown-menu rui-navbar-dropdown-notice" modifiers={ { offset: { offset: '0,12' } } }>
                        <li className="rui-navbar-dropdown-title mb-10">
                            <div className="d-flex align-items-center">
                                ...
                                <Link to="/properties" className="btn btn-custom-round">
                                    <Icon name="link2" />
                                </Link>
                            </div>
                        </li>
                ...
                >
                    <div className="rui-navbar-brand">
                        { settings.nav_logo_path ? (
                            ...
                            <Link className="rui-navbar-logo">
                                <img style={{  height: '69px', width: '50px' }} src={ settings.night_mode || settings.nav_dark ? settings.nav_logo_white_path : settings.nav_logo_path } alt="" width={ settings.nav_logo_width } />
                            </Link>
                        ) : '' }
                    ...
                    <div className={ `container${ settings.nav_container_fluid ? '-fluid' : '' }` }>
                        <div className="rui-navbar-content pooop">
                            ...
                            <ul className="nav rui-navbar-right navBarNew">
